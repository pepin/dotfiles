...
hi CursorLine       guibg=#333311 ctermbg=244
...
hi Visual          term=reverse cterm=reverse ctermbg=0 ctermfg=243
hi VisualNOS       term=bold,underline cterm=bold,underline
hi WarningMsg      term=standout ctermfg=1
hi WildMenu        term=standout ctermfg=0 ctermbg=3
hi Folded          term=standout ctermfg=241 ctermbg=0
...
hi MatchParen      term=reverse cterm=bold ctermfg=72 ctermbg=16
